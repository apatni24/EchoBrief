from redis_stream_client import redis_client, AUDIO_UPLOADED_STREAM, TRANSCRIPTION_COMPLETE_STREAM
...
async def consume_audio_uploaded():
            ...
            for stream, entries in messages:
                for msg_id, data in entries:
                    ...
                    if raw_json:
                        ...
                        print("No Data Found")
                        continue
                    asyncio.create_task(_handle_message(parsed_data))
